...
export function TopBar() {
  return (
    <header className="flex items-center justify-between gap-6 border-b border-line py-[22px]">
      ...
      <a
        href={REPO}
        className="hidden border-b border-transparent font-mono text-[13px] text-muted transition hover:border-line hover:text-ink sm:inline"
      >
